...
int main()
{
	...
	string image_path = "D:/dataset/System_data/lib0604MTCNNcrop_facenet/000000000/213110843000.png";
	string graph_path = "D:/Experiments/20180402-114759/20180402-114759.pb";
		//"D:/tensorflow-r1.7/tensorflow/examples/label_image/data/inception_v3_2016_08_28_frozen.pb";
	//graph_path = "D:/Experiments/20180402-114759/20180402-114759.pb";
	/*string labels =
		"D:/tensorflow-r1.7/tensorflow/examples/label_image/data/imagenet_slim_labels.txt";*/
	int32 input_width = 160;
	int32 input_height = 160;
	float input_mean = 0;
	float input_std = 1;
	string input_layer = "input:0";
	string input_layer2 = "phase_train:0";
	...
	if (!load_graph_status.ok()) {
		std::cerr << "error creating graph" + load_graph_status.ToString() << std::endl;
		return -1;
	}
	...
	while (num > 0)
	{
		...
		Status run_status = session->Run({ { input_layer, resized_tensor },{ input_layer2 , train } },
		...
		float features[512];
		int output_dims = t.shape().dim_size(1);
